...
do
  ...
  ffmpeg -framerate 2 -start_number 10000 -i multi/m_all_s${sec0[$i]}_${sec1[$i]}_${sec2[$i]}_t%d.png -qscale 24 -r 2 -pix_fmt yuv420p gifs/m_all_s${sec0[$i]}_${sec1[$i]}_${sec2[$i]}.gif
