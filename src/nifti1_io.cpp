...
void nifti_disp_lib_hist( void )
{
   ...
   for( c = 0; c < len; c++ )
       fputs(gni_history[c].c_str(), stdout);
}
...
*//*-------------------------------------------------------------------------*/
string nifti_datatype_string( int dt )
{
   switch( dt ){
...
*//*-------------------------------------------------------------------------*/
string nifti_units_string( int uu )
{
   switch( uu ){
...
*//*-------------------------------------------------------------------------*/
string nifti_xform_string( int xx )
{
   switch( xx ){
...
*//*-------------------------------------------------------------------------*/
string nifti_intent_string( int ii )
{
   switch( ii ){
...
*//*-------------------------------------------------------------------------*/
string nifti_slice_string( int ss )
{
   switch( ss ){
...
*//*-------------------------------------------------------------------------*/
string nifti_orientation_string( int ii )
{
   switch( ii ){
...
char *nifti_image_to_ascii( const nifti_image *nim )
{
   ...
   sprintf( buf+strlen(buf) , "  datatype_name = '%s'\n" ,
                              nifti_datatype_string(nim->datatype).c_str() ) ;
   ...
   if( nim->intent_code > 0 ){
     ...
     sprintf( buf+strlen(buf) , "  intent_code_name = '%s'\n" ,
                                nifti_intent_string(nim->intent_code).c_str() ) ;
   ...
   if( nim->xyz_units > 0 )
     sprintf( buf+strlen(buf) ,
              "  xyz_units = '%d'\n"
              "  xyz_units_name = '%s'\n" ,
              nim->xyz_units , nifti_units_string(nim->xyz_units).c_str() ) ;

   if( nim->time_units > 0 )
     sprintf( buf+strlen(buf) ,
              "  time_units = '%d'\n"
              "  time_units_name = '%s'\n" ,
              nim->time_units , nifti_units_string(nim->time_units).c_str() ) ;
   ...
   if( nim->slice_code > 0 )
     sprintf( buf+strlen(buf) ,
              "  slice_code = '%d'\n"
              "  slice_code_name = '%s'\n" ,
              nim->slice_code , nifti_slice_string(nim->slice_code).c_str() ) ;
   ...
   if( nim->qform_code > 0 ){
     ...
     "  qto_xyz_matrix = '%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g'\n" ,
         nim->qform_code      , nifti_xform_string(nim->qform_code).c_str() ,
   ...
   if( nim->sform_code > 0 ){
     ...
     "  sto_xyz_matrix = '%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g'\n" ,
         nim->sform_code      , nifti_xform_string(nim->sform_code).c_str() ,
...
int nifti_datatype_from_string( const char * name )
{
    ...
    for( c = tablen-1; c > 0; c-- )
        if( !strcmp(name, nifti_type_list[c].name.c_str()) )
            break;
...
*//*-------------------------------------------------------------------*/
string nifti_datatype_to_string( int dtype )
{
    int tablen = sizeof(nifti_type_list)/sizeof(nifti_type_ele);
    int c;
